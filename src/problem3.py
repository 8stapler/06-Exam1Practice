...
def problem3a(window, point, n):
    ...
    total = 0
    for k in range(n):
        line = rg.Line(rg.Point(point.x + (20 * k), point.y + (10 * k)), rg.Point(point2.x + (20 * k), point2.y + (10 * k)))
...
def problem3b(m, point1):
    ...
    total = 0
    for k in range(m):
        total = total + problem3a(window, rg.Point(point1.x, point1.y + (60 * k)), ((k+1)*2)+1)
